...
// console.log("함수 외부 num5 : " + num5); // num5 is not defined
...
function typeTest() {
  let temp1 = 100;
  // let temp1 = 200; // 블록 범위 변수 'temp1'을(를) 다시 선언할 수 없습니다.

  if (true) {
    // 블록 범위 확인
    let temp2 = 200;
    const temp3 = 300;
    // temp3 = 400; // Assignment to constant variable. (상수형 변수에 값 할당 불가 에러)
  }
  console.log(temp1);
  // console.log(temp2); // temp2 is not defined
  // console.log(temp3); // temp3 is not defined at typeTest

  // -----------------------------------------------------------

  // 자료형 확인
  const typeBox = document.getElementById("typeBox");
  typeBox.innerHTML = ""; // typeBox 요소 내부의 내용을 빈 문자열로 바꿈
  // == 내부 내용 삭제

  // const name2; // 상수는 선언과 동시에 초기화가 필수임

  // type of 변수명 : 해당 변수의 자료형을 반환하는 연산자
  ...
  typeBox.innerHTML += "<br>fnSum(1, 2) : " + typeof fnSum(1, 2);
