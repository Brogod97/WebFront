...
document.getElementById("btn1").addEventListener("click", function () {
  ...
  const fifthChild = document.getElementById("test").childNodes[5];
  console.log(fifthChild);

  // #test의 자식 노드 중 5번째 인덱스 노드의 마지막 자식으로 "ZZZ" 추가하기
  fifthChild.append("ZZZ");

  // #test의 자식 노드 중 5번째 인덱스의 이전 형제 노드
  console.log(fifthChild.previousSibling);

  // #test의 자식 노드 중 5번쨰 인덱스의 다음 형제 노드
  console.log(fifthChild.nextSibling);

  // #test의 자식 노드 중 5번쨰 인덱스의 이전 형제 노드의 이전 형제 노드
  console.log(fifthChild.nextSibling.nextSibling);
});
...
document.getElementById("btn2").addEventListener("click", function () {
  ...
  // nextEleementSibling : 다음 형제 요소 선택
  ...
  test.children[2].previousElementSibling.addEventListener(
    "click",
    function () {
      // this == 이벤트가 발생한 요소
      // == #test의 자식 요소 중 2번쨰 인덱스의 이전 형제 요소
